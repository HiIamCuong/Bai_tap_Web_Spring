package springthymeleaf.Controller.admin;
...
import springthymeleaf.Model.CategoryModel;
import springthymeleaf.Service.ICategoryService;
...
public class CategoryController {
	...
	public ModelAndView edit(ModelMap model,@PathVariable("categoryId") Long categoryId)
	{
		...
		{
			CategoryEntity enitity=optCategory.get();
			BeanUtils.copyProperties(catemodel, enitity);
